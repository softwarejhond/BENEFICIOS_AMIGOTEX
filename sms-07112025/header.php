    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if ($rol === 'Administrador' || $rol === 'Control maestro'): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" id="btnSendMassSMS">Enviar SMS</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
        ...
        <?php if ($rol === 'Administrador' || $rol === 'Control maestro'): ?>
            <button id="btnSubirBase" class="btn bg-magenta-dark me-2 text-white" type="button">
                <i class="bi bi-cloud-upload me-1"></i>Subir base entregas
            </button>
            <button id="btnAhorros" class="btn bg-teal-dark me-2 text-white" type="button">
                <i class="bi bi-piggy-bank-fill me-1"></i>Subir base ahorros
            </button>
